...
import { FaHandHoldingUsd, FaRegUser, FaUsersCog, FaList, FaFileAlt, FaPlus, FaTasks, FaClock, FaCheckCircle } from "react-icons/fa";
import useRole from '../hooks/useRole';

const DashboardLayout = () => {
   const { userRole, isBorrower, isManager, isAdmin } = useRole();
      ...
      <div className="drawer lg:drawer-open max-w-7xl mx-auto">
         ...
         <div className="drawer-content">
            ...
            <nav className="navbar w-full bg-base-300">
               ...
               <div className="px-4">{getDashboardTitle()}</div>
            </nav>
            {/* Page content here */}
            <Outlet></Outlet>
         </div>
