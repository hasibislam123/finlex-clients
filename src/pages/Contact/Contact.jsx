      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-5xl font-bold text-[#aad576] mb-6">
            Contact <span className="text-[#538d22]">Finlix</span>
          </h1>
          <p className="text-xl text-[#aad576] max-w-3xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div>
            <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  <div className="flex-shrink-0 p-3 rounded-full bg-[#aad576] mr-4">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">support@finlix.com</p>
                    <p className="text-gray-600">info@finlix.com</p>
                  </div>
                </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8">
              ...
              <div className="flex space-x-4">
                <a href="#" className="p-3 bg-[#538d22] rounded-full text-white hover:bg-[#427a19] transition duration-300">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full px-4 py-3 bg-[#538d22] hover:bg-[#427a19] text-white font-semibold rounded-lg shadow-md transition duration-300 ease-in-out"
              >
                Send Message
              </button>
            </form>
